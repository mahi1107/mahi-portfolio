      ...
      <div className='flex gap-5'>
        {[...Array(dots)].map((_, i) => (
          ...
          >
            ...
            >
              <div 
                className='w-full h-full rounded-full bg-gradient-to-b from-orange-300 to-orange-600 shadow-[0_0_15px_rgba(251,146,60,0.6)]'
                style={{
            ...
            <div 
               className='absolute bottom-0 w-10 h-3 border border-orange-500/30 rounded-[100%] opacity-0'
               style={{
            ...
            {/* 3. REFLECTIVE SHADOW */}
            <div 
              className='absolute -bottom-1 w-5 h-1.5 rounded-[100%] bg-orange-500/40 blur-sm'
              style={{
